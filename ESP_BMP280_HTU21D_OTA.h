...
const char *HTU_TEMP_C_TOPIC         = "AdamsDesk/8266/HTU21D/tempC";   // The topic used to publish the temperature in Celsius.
const char *HTU_TEMP_F_TOPIC         = "AdamsDesk/8266/HTU21D/tempF";   // The topic used to publish the temperature in Fahrenheit.
const char *HTU_HUMIDITY_TOPIC       = "AdamsDesk/8266/HTU21D/humidity";// The topic used to publish the htuHumidity.
const char *BMP_TEMP_C_TOPIC         = "AdamsDesk/8266/BMP280/tempC";   // The topic used to publish the temperature in Celsius.
const char *BMP_TEMP_F_TOPIC         = "AdamsDesk/8266/BMP280/tempF";   // The topic used to publish the temperature in Fahrenheit.
const char *BMP_PRESSURE_TOPIC       = "AdamsDesk/8266/BMP280/pressure";// The topic used to publish the htuHumidity.
...
float htuHumidityArray[] = { 21.12, 21.12, 21.12 };                     // An array to hold the 3 most recent values.
float bmpTempCArray[]    = { 21.12, 21.12, 21.12 };                     // An array to hold the 3 most recent Celsius values.
float bmpPressureArray[] = { 1024.0, 1024.0, 1024.0 };                  // An array to hold the 3 most recent values.
